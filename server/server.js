...
let iceCreams = [
    ...
    { id: 7, name: 'Pistachio' },
    { id: 8, name: 'Butter Scotch' },
    { id: 9, name: 'Vanilla' },
    { id: 10, name: 'Mint Chocolate Chip' },
...
let menuData = [
    ...
    {
        id: 2,
        iceCream: { id: 5, name: 'Mango' },
        inStock: true,
        price: 3.0,
        quantity: 10,
        description: 'Rich and creamy mango ice cream.',
    },
    {
        id: 3,
        iceCream: { id: 3, name: 'Cookies and Cream' },
        inStock: false,
        price: 2.8,
        quantity: 0,
    ...
    {
        id: 6,
        iceCream: { id: 10, name: 'Mint Chocolate Chip' },
        inStock: false,
        price: 3.2,
        quantity: 50,
    ...
    {
        id: 7,
        iceCream: { id: 9, name: 'Vanilla' },
        inStock: true,
        price: 3.8,
        quantity: 40,
        description: 'Vanilla ice cream with marshmallow and chocolate.',
    },
];
